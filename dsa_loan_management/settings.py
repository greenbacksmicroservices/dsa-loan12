...
AUTHENTICATION_BACKENDS = [
    'core.auth_backends.EmailUsernameEmployeeAgentBackend',
...
# Password reset email settings (use environment variables — never hardcode app password)
import os
...
EMAIL_HOST_USER = config(
    'EMAIL_HOST_USER',
    default=os.getenv('EMAIL_HOST_USER', 'elitedreamcapital@gmail.com'),
).strip()
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default=os.getenv('EMAIL_HOST_PASSWORD', '')).replace(' ', '')
EMAIL_USE_SSL = config('EMAIL_USE_SSL', default=False, cast=bool)
EMAIL_USE_TLS = False if EMAIL_USE_SSL else config('EMAIL_USE_TLS', default=True, cast=bool)
EMAIL_TIMEOUT = config('EMAIL_TIMEOUT', default=20, cast=int)
DEFAULT_FROM_EMAIL = config(
    'DEFAULT_FROM_EMAIL',
    default=os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'elitedreamcapital@gmail.com'),
).strip()
