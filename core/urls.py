...
urlpatterns = [
    ...
    path('admin/loans/<int:loan_id>/delete/', admin_views.delete_loan, name='delete_loan'),
    ...
    path('admin/employees/add/', views.admin_employees_add, name='admin_employees_add'),
    path('admin/employees/mine/', views.admin_my_employees, name='admin_my_employees'),
    path('admin/all-agents/', views.admin_all_agents, name='admin_all_agents'),
    path('admin/agents/', views.admin_agents_list, name='admin_agents_list'),
    path('admin/agents/add/', views.admin_agents_add, name='admin_agents_add'),
    path('admin/agents/mine/', views.admin_my_agents, name='admin_my_agents'),
    ...
    path('admin/partners/add/', admin_views.admin_partners_add, name='admin_partners_add'),
    path('admin/partners/', admin_views.admin_partners_list, name='admin_partners_list'),
    ...
    path('api/employee/agents/<int:agent_id>/detail/', employee_views_new.employee_agent_detail_api, name='api_employee_agent_detail'),
