...
urlpatterns = [
    ...
    path('admin/new-entries/', views.admin_new_entries, name='admin_new_entries'),
    path('admin/in-processing/', views.admin_in_processing, name='admin_in_processing'),
    path('admin/follow-ups/', views.admin_follow_ups, name='admin_follow_ups'),
    path('admin/approved/', views.admin_approved, name='admin_approved'),
    path('admin/rejected/', views.admin_rejected, name='admin_rejected'),
    path('admin/disbursed/', views.admin_disbursed, name='admin_disbursed'),
